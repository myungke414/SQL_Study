...
CONSTRAINT STADIUM_PK PRIMARY KEY (STADIUM_ID) /* 참조 스타디움의 기본키는 스타디움아이디 */
);
CREATE TABLE TEAM (
...
CONSTRAINT TEAM_PK PRIMARY KEY (TEAM_ID), /* 참조 팀의 기본키는 팀아이디 */
CONSTRAINT TEAM_FK FOREIGN KEY (STADIUM_ID) REFERENCES STADIUM(STADIUM_ID) /* 참조 스타디움의 기본키인 스타디움 아이디의 외래키인 팀의 스타디움 아이디 */
);
...
CONSTRAINT SCHEDULE_PK PRIMARY KEY (STADIUM_ID, SCHE_DATE), /* 참조 SCHEDULE의 기본키는 STADIUM_ID, SHCE_DATE */
CONSTRAINT SCHEDULE_FK FOREIGN KEY (STADIUM_ID) REFERENCES STADIUM(STADIUM_ID) /* 참조 스타디움의 기본키인 STADIUM_ID는 SCHEDULE의 외래키 */
);
...
CONSTRAINT PLAYER_PK PRIMARY KEY (PLAYER_ID), /* 참조 PLAYER의 PLAYER_ID는 기본키 */
CONSTRAINT PLAYER_FK FOREIGN KEY (TEAM_ID) REFERENCES TEAM(TEAM_ID) /* 참조 TEAM의 기본키인 TEAM_ID는 PLAYER의 외래키인 TEAM_ID */
);
